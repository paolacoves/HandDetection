...
nombre = "puno"
directorio = "C:/Users/16pao/OneDrive/Escritorio/Teleco/Scbio/Flappymp/Fotos/entrenamiento"
...
while True:
    ...
    if resultado.multi_hand_landmarks:                          # si detecto alguna mano
        for mano in resultado.multi_hand_landmarks:
            ...
            cv2.imwrite(carpeta+"/puno_{}.jpg".format(cont), dedos_reg)
            cont = cont + 1
            time.sleep(0.05)

    cv2.imshow("Video", frame)
    k = cv2.waitKey(1)
    if k == 27 or cont >= 20:       # Cuando tengamos guardadas 300 fotos
        break
